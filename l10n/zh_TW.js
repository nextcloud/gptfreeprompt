OC.L10N.register(
    ...
    "A Smart Picker for interfacing with the GPT integrations that provide free prompt capability" : "用於與提供自由提示功能的 GPT 整合連結的智慧挑選程式",
    "A unified Smart Picker for Nextcloud large language model integrations that provide free prompting capability." : "Nextcloud 大型語言模型整合的統一智慧型挑選程式，提供自由提示功能。",
