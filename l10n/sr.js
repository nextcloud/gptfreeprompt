OC.L10N.register(
    ...
    "Failed set a notification: Uknown user" : "Није успело постављање обавештења: непознати корисник",
    ...
    "A SmartPicker for interfacing with the GPT integrations that provide free prompt cabability" : "Паметни бирач за интеракцију са GPT интеграцијама које обезбеђују бесплатну услугу пријема захтева",
    "A unified SmartPicker for Nextcloud large language model integrations that provide free prompting cabability." : "Објединњени Паметни бирач за Nextcloud интеграције великог језичког модела који обезбеђује могућност бесплатног слања захтева.",
