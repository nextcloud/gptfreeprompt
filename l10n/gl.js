OC.L10N.register(
    "gptfreeprompt",
    {
    "Text generation ready" : "Xeración de texto lista",
    "View" : "Ver",
    "Delete" : "Eliminar",
    ...
    "Failed process prompt" : "Proceso fallado de indicación.",
    ...
    "Failed to retrieve outputs" : "Produciuse un fallo ao recuperar as saídas",
    "Failed to cancel generation" : "Produciuse un fallo ao cancelar a xeración",
    "Failed to set notification: Unknown user" : "Produciuse un fallo ao definir unha notificación: usuario descoñecido",
    "Failed to set notification: Generation not found" : "Produciuse un fallo ao definir unha notificación: non se atopou a xeración",
    "Failed to set notification: Unknown error" : "Produciuse un fallo ao definir unha notificación: erro descoñecido",
    "GptFreePrompt" : "Indicador GptFree",
    "A Smart Picker for interfacing with the GPT integrations that provide free prompt cabability" : "Un Selector intelixente para interactuar coas integracións de GPT que fornezan a posibilidade de indicación de balde.",
    "A unified Smart Picker for Nextcloud large language model integrations that provide free prompting cabability." : "Un selector intelixente unificado para integracións de grandes modelos idiomas de Nextcloud que fornezan a posibilidade de indicación de balde.",
    ...
    "Copy text to clipboard" : "Copiar o texto no portapapeis",
    "Reset" : "Restabelecer",
    "Include prompt" : "Incluír a indicación",
    "Unexpected server response" : "Resposta non agardada do servidor",
    "This generation has been deleted." : "Esta xeración foi eliminada.",
    ...
    "ERROR: No free prompt provider available" : "ERRO: non hai ningún fornecedor de indicacións de balde dispoñíbel",
