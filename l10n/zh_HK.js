OC.L10N.register(
    ...
    "Failed set a notification: Uknown user" : "設定通知失敗：未知的用戶",
    ...
    "A SmartPicker for interfacing with the GPT integrations that provide free prompt cabability" : "用於與 GPT 整合互動的智慧型挑選程式，提供免費的提示功能",
    "A unified SmartPicker for Nextcloud large language model integrations that provide free prompting cabability." : "Nextcloud 大型語言模型整合的統一智慧型挑選程式，提供免費的提示功能。",
