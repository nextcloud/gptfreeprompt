OC.L10N.register(
    "gptfreeprompt",
    {
    "Text generation ready" : "التوليدة النصية جاهزة",
    "View" : "عرض",
    "Delete" : "حذف",
    ...
    "Failed to create a generation" : "فشل في إنشاء التوليدة",
    ...
    "Failed set a notification: Uknown user" : "فشل في وضع إشعار: المستخدم غير معروف",
    "Failed to set notification: Generation not found" : "فشل في وضع إشعار: التوليدة غير موجودة",
    "Failed to set notification: unknown error" : "فشل في وضع إشعار: خطأ غير محدد",
    "GptFreePrompt" : "GptFreePrompt",
    "A SmartPicker for interfacing with the GPT integrations that provide free prompt cabability" : "لاقط ذكي للتواصل مع تكاملات GPT التي توفر إمكانية المطالبة المجانية",
    "A unified SmartPicker for Nextcloud large language model integrations that provide free prompting cabability." : "لاقط ذكي مُوحّد لتكاملات النموذج اللغوي الضخم لنكست كلاود و التي تُوفِّر إمكانية المٌطالبة المجانية.",
    ...
    "This can take a while..." : "هذا ربما يستغرق بعض الوقت ...",
    ...
    "This generation has been deleted." : "هذه التوليدة تمّ حذفها",
