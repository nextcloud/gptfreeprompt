OC.L10N.register(
    ...
    "The text generation task was scheduled to run in the background." : "テキスト生成タスクがバックグラウンドで実行されるようにスケジュールされていました。",
    "Estimated completion time: " : "完成予定時期: ",
    "This can take a while…" : "少々お待ちください。",
    ...
    "Regenerate" : "再生成する",
    "Preview" : "プレビュー",
    "You will be notified when the text generation is ready." : "テキスト生成が感性してらあなたに通知します",
